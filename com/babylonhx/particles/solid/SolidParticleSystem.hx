...
class SolidParticleSystem implements IDisposable {
	...
	*/
	...
	private var _depthSortedIndices:Int32Array;
	...
	*/
	public function buildMesh():Mesh {
		...
		if (this._depthSort) {
			this._depthSortedIndices = new Int32Array(this._indices); //(this._needs32Bits) ? new UInt32Array(this._indices) : new Uint16Array(this._indices);
