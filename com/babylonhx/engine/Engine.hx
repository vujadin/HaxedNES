...
@:expose('BABYLON.Engine') class Engine {
	...
	public function updateDynamicIndexBuffer(indexBuffer:WebGLBuffer, indices:Int32Array, offset:Int = 0) {
	...
	inline public function createIndexBuffer(indices:Int32Array, updatable:Bool = false):WebGLBuffer {
		var vbo = gl.createBuffer();
		var ret = new WebGLBuffer(vbo);		
