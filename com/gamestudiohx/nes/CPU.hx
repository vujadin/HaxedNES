...
class CPU {
	...
	public static inline var CPU_FREQ_NTSC:Float = 1789772.5; //1789772.72727272d;
	...
	static var cycTable:Vector<Int> = Vector.fromArrayCopy([
	...
	static var instname:Vector<String> = Vector.fromArrayCopy([
	...
	static var JSON_PROPERTIES:Array<String> = [
    ...
    inline function doNonMaskableInterrupt(status:Int) {
