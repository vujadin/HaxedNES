...
class Tile {
    ...
    inline public function setScanline(sline:Int, b1:Int, b2:Int) {
        initialized = true;
        tIndex = sline << 3;
        for (x in 0...8) {
    ...
    inline public function render(buffer:Vector<Int>, srcx1:Int, srcy1:Int, srcx2:Int, srcy2:Int, dx:Int, dy:Int, palAdd:Int, palette:Vector<Int>, flipHorizontal:Bool, flipVertical:Bool, pri:Int, priTable:Vector<Int>) {
