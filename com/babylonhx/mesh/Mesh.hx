...
@:expose('BABYLON.Mesh') class Mesh extends AbstractMesh implements IGetSetVerticesData implements IAnimatable {
	...
	override public function setIndices(indices:Int32Array, totalVertices:Int = -1, updatable:Bool = false) {
		if (this._geometry == null) {
			var vertexData = new VertexData();
     ...
     * Returns the Mesh. 
     */
    public function updateIndices(indices:Int32Array, offset:Int = 0):Mesh {
        if (this._geometry == null) {
            return this;
        }
